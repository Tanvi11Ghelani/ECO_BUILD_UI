                    ...
                    <div className="row align-items-center g-4">
                        <div className="col-md-4">
                            <div className="layer_image small-round-layer border border-blue h-auto">
                                <img alt=""src="Images/DURALOK-Technology.jpg" />
                            </div>
            ...
            <section className="pt-0">
                <div className="container">
                    <div className="row align-items-center g-4">
                        ...
                        <div className="col-md-4">
                            <div className="layer_image small-round-layer border border-blue h-auto">
                                <img alt=""src="Images/DURAFOLD-Technology.jpg" />
                            </div>
            ...
            <section className="pt-0">
                <div className="container">
                    <div className="row align-items-center g-4">
                        <div className="col-md-4">
                            <div className="layer_image small-round-layer border border-blue h-auto">
                                <img alt=""src="Images/DURAMAX-Technology.jpg" />
                            </div>
            ...
            <section className="pt-0">
                <div className="container">
                    <div className="row align-items-center g-4">
                        ...
                        <div className="col-md-4">
                            <div className="layer_image small-round-layer border border-blue h-auto">
                                <img alt=""src="Images/4WAY-REVERSIBLE-System.jpg" />
                            </div>
            ...
            <section className="pt-0">
                <div className="container">
                    <div className="row align-items-center g-4">
                        ...
                        <div className="col-sm-12 col-md-12 col-lg-6">
                            <div className="layer_image small-round-layer border border-blue h-auto">
                                <img alt=""src="Images/Threshold-Sealer.jpg" />
                            </div>
