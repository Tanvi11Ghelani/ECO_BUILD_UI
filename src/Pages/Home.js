              ...
              <div className="container">
                  ...
                  <div className="row g-4">
                      ...
                      <div className="action-band d-flex align-item-center justify-content-center">
                          <a   className="btn-primary icon-btn">{t('view_all_products')}<i
                          ...
                          <div className="item pl-2">
                              <div className="border-card">
                                  ...
                                  <div className="action-band mt-3 d-flex align-item-center justify-content-center">
                                      <a   className="btn-primary icon-btn border-btn-primary">{t('learn_more')}<i
                                              className="fa-solid fa-arrow-right"></i></a>
                                  </div>
                              </div>
                          </div>
          ...
          <section className="white-bg">
              <div className="container-fuild">
                  ...
                  <div className="brand-card-band">
                      <ul>
                          <li><a   target="_blank"> <img alt=""src="Images/brand-logo/brand-01.png" /> </a></li>
                          <li><a   target="_blank"> <img alt=""src="Images/brand-logo/brand-02.png" /> </a></li>
                          <li><a   target="_blank"> <img alt=""src="Images/brand-logo/brand-03.png" /> </a></li>
                          <li><a   target="_blank"> <img alt=""src="Images/brand-logo/brand-04.png" /> </a></li>
                          <li><a   target="_blank"> <img alt=""src="Images/brand-logo/brand-05.png" /> </a></li>
                          <li><a   target="_blank"> <img alt=""src="Images/brand-logo/brand-06.png" /> </a></li>
                      </ul>
                  </div>
              </div>
          </section>
