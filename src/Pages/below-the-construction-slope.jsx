                  ...
                  <table className="dltrc" style={{ background: "none" }}>
                    <tbody>
                      ...
                      {filteredData.map((item, index) => (
                        ...
                        <td className="dlinfo hover01">
                          <a href={item.pdf} className="explanation-link" target="_blank" rel="noopener noreferrer">
                        ...
                        <td className="dlinfo hover01">
                          <ul className="file-list-inner-td">
                            <li>
                              <a href={item.pdf} download={`${item.code}.pdf`} className="red-link" target="_blank" rel="noopener noreferrer">
                                <div className="icon-band">
                            ...
                            <li>
                              <a href={item.dwg} download={`${item.code}.dwg`} className="blue-link">
                                <div className="icon-band">
                    ...
                    <table className="dltrc" style={{ background: "none" }}>
                      <tbody>
                        ...
                        {filteredData.filter(item => item.pdf.includes('StemWall')).map((item) => (
                          ...
                          <td className="dlinfo hover01">
                            <a href={item.pdf} target="_blank" className="explanation-link" rel="noopener noreferrer">
                              {t("belowConstructionSlope.explanationPage")}
                            </a>
                          </td>
                          <td className="dlinfo hover01">
                            <ul className="file-list-inner-td">
                              <li>
                                <a href={item.pdf} download={`${item.fileName}.pdf`} rel="noopener noreferrer" className="red-link">
                                  <div className="icon-band"><img src={image9} alt="PDF" /></div>
                                  {t('pdf')}
                                  <img src={image10} className="download-icon" alt="Download" />
                                </a>
                              </li>
                              <li>
                                <a href={item.dwg} className="blue-link" download={`${item.fileName}.dwg`}>
                                  <div className="icon-band"><img src={image11} alt="DWG" /></div>
                                  {t('dwg')}
                                  <img src={image10} className="download-icon" alt="Download" />
                                </a>
                              </li>
                      ...
                      <tr className="dlinfo" key={index}>
                        ...
                        <td className="dlinfo hover01">
                          <ul className="file-list-inner-td">
                            <li>
                              <a href={item.pdf} download={`${item.fileName}.pdf`} rel="noopener noreferrer" className="red-link">
                                <div className="icon-band"><img src={image9} alt={t('pdf_icon')} /></div>
                                {t('pdf')}
                                <img src={image10} className="download-icon" alt={t('download')} />
                              </a>
                            </li>
                            <li>
                              <a href={item.dwg} download={`${item.fileName}.dwg`} className="blue-link">
                                <div className="icon-band"><img src={image11} alt={t('dwg_icon')} /></div>
                                {t('dwg')}
                                <img src={image10} className="download-icon" alt={t('download')} />
                              </a>
                            </li>
