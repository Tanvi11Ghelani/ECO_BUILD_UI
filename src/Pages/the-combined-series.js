                            ...
                            <div className="container">
                                <div className="ab-info-band">
                                    ...
                                    <div className="text-band">
                                        ...
                                        <p>{t('installation_is_simple_and_quick_compared_to_traditional_underfloor_heating_insulation_methods_which_require_several_steps_to_lay_the_heating_pipes_hydrofoam_boards_measuring_1_2m_x_1_2m_are_available_in_two_thicknesses_64mm_and_102mm_they_can_be_easily_installed_using_an_interlocking_system_that_overlaps_on_all_four_sides_ensuring_the_boards_remain_locked_in_place_while_you_work_hydrofoam_uses_a_multi_directional_friction_based_3600_anchoring_kit_that_eliminates_the_need_for_wire_mesh_it_is_very_easy_to_install_the_underfloor_heating_pipes_in_place_in_any_desired_direction')}</p>
                                        <p>{t('hydrofoam_offers_installers_a_highly_dense_yet_lightweight_expanded_polystyrene_eps_product_used_as_insulation_for_underfloor_heating_that_increases_installation_speed_is_easy_to_cut_to_any_desired_angle_or_radius_and_provides_an_insulation_value_of_u_0_56_or_u_0_35')}</p>
                            ...
                            <div className="container">
                                ...
                                <div className="ab-info-band">
                                    ...
                                    <div className="text-band">
                                        ...
                                        <p>{t('simply_attach_the_standard_1_2_x_2_4m_nudura_panels_to_the_wall_using_the_embedded_connection_strip_and_suitable_fasteners_nudura_retrofit_insulation_panels_interlock_perfectly_it_is_easy_to_complete_electrical_wiring_and_attach_plasterboard_or_gypsum_board_using_the_64mm_wide_connection_strip_at_400mm_intervals_to_install_ready_to_finish_wall_insulation')}</p>
                                        <p>{t('as_energy_demands_and_fuel_prices_increase_there_is_a_need_to_make_the_most_of_wall_insulation_technologies_in_homes_and_commercial_buildings_nudura_s_retrofit_wall_insulation_technology_is_an_ideal_solution_that_reduces_energy_consumption_increases_savings_and_adds_presence_all_in_one_process')}</p>
