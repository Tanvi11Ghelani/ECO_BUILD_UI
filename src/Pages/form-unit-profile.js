...
const FormUnitProfile = () => {
  ...
  // Combine all data arrays into one for easier searching
  const allData = [
    {
      ...
      category: t("concrete_core_mold_102_mm"),
    },
    {
    ...
    // 6 inch data
    {
      ...
      category: t("152mm_6_concrete_core_forms"),
    },
    {
    ...
    // 8 inch data
    {
      ...
      category: t("203mm_8_concrete_core_forms"),
    },
    {
    ...
    },
    {
      ...
      dwg: "EcoBuildPdf/FormUnitProfiles/203mm- 8 Concrete Core Forms/a8a03.dwg",
      category: t("203mm_8_concrete_core_forms"),
    },
    {
    ...
    // 10 inch data
    {
      ...
      category: t("254mm_10_concrete_core_forms"),
    },
    {
    ...
    // 12 inch data
    {
      ...
      category: t("305mm_12_concrete_core_forms"),
    },
    {
    ...
    // 8 XR inch data
    {
      ...
      category: t("8_203mm_xr35_concrete_core_forms"),
    },
    {
  ...
  // Render table for a given data array
  const renderTable = (data, category) => {
    if (!data || data.length === 0) return null;

    return (
      <section className="pt-0" key={category}>
        <div className="container">
          ...
          <table className="dltrc" style={{ background: "none" }}>
            <tbody>
              ...
              {data.map((item, index) => (
                <tr className="dlinfo" key={`${category}-${index}`}>
          ...
          <div className="row align-items-center">
            <div className="col-md-12">
              <div className="layer_content p-0 m-mb-0">
                <h3 className="text-primary mb-3 m-mb-0">
