  ...
  return (
    <div className="ecobuild-academy-page">
      ...
      <section className="academy-info-section">
        {/* Section Title */}
        <h3 className="academy-section-title">{t("academy.sectionTitle")}</h3>
        ...
        <div className="academy-cards-grid">
          ...
          <div className="academy-card academy-card-dark">
            <div className="academy-card-icon">
              <img src={bookIcon} alt={t("academy.cards.bookIconAlt")} />
            </div>
          ...
          <div className="academy-card academy-card-blue">
            <div className="academy-card-icon">
              <img src={writeIcon} alt={t("academy.cards.writeIconAlt")} />
            </div>
            <p className="academy-card-text">{t("academy.cards.courseCost")}</p>
          </div>

          {/* Card 3 - Course Hours (Bright Blue/Teal) */}
          <div className="academy-card academy-card-blue">
            <div className="academy-card-icon">
              <img src={clockIcon} alt={t("academy.cards.clockIconAlt")} />
            </div>
            <p className="academy-card-text">
          ...
          <div className="academy-card academy-card-dark">
            <div className="academy-card-icon">
              <img
                src={clipboardIcon}
                alt={t("academy.cards.clipboardIconAlt")}
              />
            </div>
            <p className="academy-card-text">
      ...
      <section className="important-info-section">
        <h3 className="important-info-title">{t("academy.important.title")}</h3>
        <div className="important-info-content">
          <p>{t("academy.important.text")}</p>
        </div>
      </section>
